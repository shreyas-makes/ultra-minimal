I'm a designer turned entrepreneur, now a product manager. I have 7+ years of experience shipping products and services across femtech, healthcare, education, cleantech and SaaS. B2B and B2C.
...
I like creating things (writing, designing, coding, startups). Startups are cool because they're positive sum, profitable & impactful.

Throughout my work, I've helped support the navigation of difficult lives through my creations— [high-risk mothers](https://blog.shreyasprakash.com/res/), [alzheimers patients](https://vimeo.com/399509793), [healthcare workers](https://apps.apple.com/in/app/care-companion-india/id6468563195), [deaf-blind runners](https://blog.shreyasprakash.com/equarun/), [rural artisans](#), [tribal children](https://blog.shreyasprakash.com/res/) etc.

On the side, I run half marathons, hang out at coffee roasters, and write essays about product, culture and craft. In the weekends, I'm usually building full-stack apps using Ruby on Rails, inching closer to be a [founder/hacker](https://www.founderhacker.com/) one day.

Some questions I'm pondering upon
-

- How might we make the [1:1 mentorship](https://en.wikipedia.org/wiki/Bloom%27s_2_sigma_problem) scalable?
...
- Five years from now, what would the tech stack of a solopreneur building digital businesses look like?
...
*   [English is the hot new programming language](https://blog.shreyasprakash.com/english-is-the-hot-new-programming-language/) — How ChatGPT has improved my programming skills
...
*   [Methods are life jackets, not straight jackets](https://blog.shreyasprakash.com/methods-are-lifejackets-not-straight-jackets/)
...
For more essays covering various topics, view my [infinite-scroll blog here.](https://blog.shreyasprakash.com/)

Want more ideas in your inbox? I write about growth, design and leadership. [Subscribe here.](https://blog.shreyasprakash.com/#/portal/signup/free)
