...
The [Build School website](https://www.buildschool.net/) is finally live!

As a rebranding exercise, it did stretch my grey cells to push the limits and make it match with the right vibe: professionalism with a powerful vibrant punch. These were the only two keywords that were mentioned to me for the rebranding exercise, nothing else. I went on to creatively unfurl, giving me enough creative freedom and room to come up with a version that just 'clicked'.

The process reminds me of Christopher Nolan's approach while collaborating with composer Hans Zimmer for the Interstellar soundtrack.

Instead of revealing the film's plot, Nolan wrote a short story about a father leaving his child to complete an important job, with just two lines of dialogue: "I'll come back" and "When?"[🔗](https://en.wikipedia.org/wiki/Interstellar_%28soundtrack%29) He asked Zimmer to spend one day composing musical interpretations of that story. Zimmer wrote a four-minute piano and organ piece representing his idea of fatherhood, which became the heart of the film's score.

Sometimes, less is more.

If you're curious about the earlier design, [you can view it here.](https://buildbystl.com/)
...
I recently completed a redesign project for Build School. Brand redesigns are challenging because the new brand must be significantly better than the previous one. This project involved various co-creative exercises with the leadership team and extensive back-and-forth on the theme and design system. We explored different ideas to ensure the final design resonated with our expectations.
