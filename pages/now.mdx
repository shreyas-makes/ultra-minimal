...
I've been meticulously working on a 10,000 word essay draft on 'Building your first Rails app'. This is primarily aimed at beginner Rubyists who want to build their first internet product. I've been writing for hours at a stretch. I'm really not sure if this is an appropriate length for an essay, mini-book, or even a book? 25% in progress, and it's already 3000 words long.

I've taken a first-principles approach towards writing this tutorial blog. Most tutorial blogs are aimed at expert developers, and would make your head spin especially if you're diving into Ruby code for the first time. I've taken great care to make it simple and explain even the simplest of terms which native programmers would take for granted.
