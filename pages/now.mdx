...
I'm currently in Dhaka, Bangladesh for an upcoming product launch at Noora Health. This is the fifth visit to Dhaka, and it's been very refreshing to come here again!

As always, I've been partaking in what feels like a religious rite-of-passage ritual by indulging in kachhi biryani for lunch at Dhaka. In fact, that was the first thing I did after landing here in Dhaka, and I've been having it every time I usually come here for a visit.

I also visited my favourite cafe in this part of town, [North End Coffee Roasters](http://www.northendcoffee.com/) for a good pour-over black coffee. One notable observation is the proliferation of various Japanese/Korean restaurants in this part of Dhaka — Koreana, Samdado, Sura Korean, Goong, Kona Cafe, to name a few.

Here are my top culinary picks from this trip so far:

1. Kachi biryani with borhani and jali kabab. The three best biryanis in my order of preference: [Kacchi Bhai](https://www.kacchibhai.com/), [Pagla Baburchi](https://www.paglababurchi.net/menus) and [Sultan's dine](https://sultansdinebd.com/))
2. Hot Kung Pao chicken at [Kona Cafe](https://www.konacafedhaka.com/shop)
3. (will be adding more to this list)

# Sun, 30 Jun, 2024

I made my first software-related open source contribution! I specifically mention 'software-related', as I'd contributed to the [open-source hardware movement during the 2020 pandemic](https://blog.shreyasprakash.com/sterilo). Making my npm package publicly accessible for anyone to use did hit me differently.
...
You could install this [npm package here](https://www.npmjs.com/package/dftree?activeTab=readme), let me know your thoughts :)

# Mon, 24 Jun, 2024

## SvelteJS + Ruby on Rails

I published two new blog posts. In one of the blogs, I talk about the 'meeting before the meeting' preparation for product managers. In the other essay, I [talk about my process of arriving at a web development stack](https://blog.shreyasprakash.com/sveltejs-ruby-rails-setup/) that mixes the old and the new in an anachronistic fashion. I've attempted to combine a 20 year old framework (Ruby on Rails), with the latest fancy new JS framework (SvelteJS).

Currently attempting to learn SvelteJS by sitting through this [24-hour Youtube tutorial here](https://www.youtube.com/watch?v=UGBJHYpHPvA) by FreeCodeCamp. Tempted to say this to my partner, "Hi, don't let anyone disturb me till tomorrow!!".

## Decentralised Science, Balaji S, Vitalik Buterin

I've also been reading a lot about the recent tailwinds centered around decentralised science. I was listening in to the [DeSci Podcast episodes starring Balaji S](https://www.youtube.com/watch?v=xrcRI_hYDtQ&t=2285s), and [Vitalik Buterin around innovations](https://www.youtube.com/watch?v=qtBsL90-J_4&t=1940s) that could push the paradigm of academic research from 'reputation based citation' to 'independent replication'. The podcast episodes covered various fascinating ideas around how this paradigm could be made possible.
