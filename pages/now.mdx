...
Zimmer was just given two lines of a dialogue: "I'll come back" and "When?"[🔗](https://en.wikipedia.org/wiki/Interstellar_%28soundtrack%29) instead of the entire film's plot. Zimmer then went on to write a four-minute piano and organ piece representing his idea of fatherhood, which became the heart of the film's score.
