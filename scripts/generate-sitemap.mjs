...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  <url>
    <loc>https://shreyasprakash.com</loc>
  </url>
  <url>
    <loc>https://shreyasprakash.com/writing</loc>
  </url>
  <url>
    <loc>https://shreyasprakash.com/engineering</loc>
  </url>
  <url>
    <loc>https://shreyasprakash.com/books</loc>
  </url>
  <url>
    <loc>https://shreyasprakash.com/notes</loc>
  </url>${allSlugs
    .map((slug) => {
      return `
  <url>
    <loc>${`https://shreyasprakash.com${slug}`}</loc>
  </url>`;
    })
    .join("")}
</urlset>`;
